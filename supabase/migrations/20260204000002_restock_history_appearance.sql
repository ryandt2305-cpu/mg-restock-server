-- Rebuild history using appearance events (item enters stock relative to previous snapshot)
...
begin
  ...
  loop
    ...
    values (item_id, p_shop_type, 1, coalesce(item_stock, 0), p_ts, p_ts, item_stock, item_stock)
